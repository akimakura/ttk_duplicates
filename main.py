...
name_exl_1 = input("Напишите название первого файла, по примеру *** имя_файла.xls *** = ")
name_exl_2 = input("Напишите название второго файла, по примеру *** имя_файла.xls *** = ")
...
excel_file = 'по_обоим_напрвлениям_пострадают.xlsx'
